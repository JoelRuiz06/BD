...
ALTER TABLE PRESTAMO MODIFY FECHA_PRESTAMO DEFAULT SYSDATE;
...
ALTER TABLE PRESTAMO DROP CONSTRAINT FK2_PRESTAMO;
...
ALTER TABLE BIBLIOTECARIO DROP CONSTRAINT FK_BIBLIOTECARIO;
...
ALTER TABLE ATENCION DROP CONSTRAINT FK_ATENCION;
...
ALTER TABLE ATENCION ADD COD_ATENCION NUMBER(10);
...
INSERT INTO ATENCION (COD_ATENCION, COD_BIBLIOTECARIO, COD_LECTOR, FECHA) VALUES (1, 1, 1, SYSDATE);
