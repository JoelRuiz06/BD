DROP TABLE T4BOL2EJER3.CLIENTE CASCADE CONSTRAINTS;

DROP TABLE T4BOL2EJER3.DETALLE_PEDIDO CASCADE CONSTRAINTS;

DROP TABLE T4BOL2EJER3.EMPLEADO CASCADE CONSTRAINTS;

DROP TABLE T4BOL2EJER3.GAMA_PRODUCTO CASCADE CONSTRAINTS;

DROP TABLE T4BOL2EJER3.OFICINA CASCADE CONSTRAINTS;

DROP TABLE T4BOL2EJER3.PAGO CASCADE CONSTRAINTS;

DROP TABLE T4BOL2EJER3.PEDIDO CASCADE CONSTRAINTS;

DROP TABLE T4BOL2EJER3.PRODUCTO CASCADE CONSTRAINTS;


CREATE TABLE GAMA_PRODUCTO (
    GAMA VARCHAR2(50),
    DESCRIPCION_TEXTO VARCHAR2(3000),
    DESCRIPCION_HTML VARCHAR2(3000),
    IMAGEN VARCHAR2(256),
